package com.facci.androidrealm;
...
import com.facci.androidrealmtutorial.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showData(){
        ...
        for(int i=0;i<dataModels.size();i++){
            output.append("ID : "+dataModels.get(i).getId()+" Nombre : "+dataModels.get(i).getName()+" Cantidad : "+dataModels.get(i).getAge()+" Tipo : "+dataModels.get(i).getGender()+" \n");
        }
    }
}
